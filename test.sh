...
-hls_flags independent_segments -hls_segment_filename "static/encoded/%v/seg_%03d.ts" -master_pl_name "master.m3u8" "static/encoded/%v/sub-pl.m3u8" #"static/encoded/name-%v.m3u8" -master_pl_name "name-pl.m3u8"
